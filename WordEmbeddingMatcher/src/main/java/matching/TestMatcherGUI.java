...
public class TestMatcherGUI {
	...
	public static void main(String[] args) throws AlignmentException, IOException, URISyntaxException, OWLOntologyCreationException {
		...
		System.out.print("Matcher to run (either 'WE-LABEL' or 'WE-GLOBAL'): ");
		String MATCHER = scanner.next();
		

		System.out.print("\nPath to ontology 1:");
		String ontoFile1Path = scanner.next();
		
		System.out.print("\nPath to ontology 2:");
		String ontoFile2Path = scanner.next();
		
		System.out.print("\nPath to vector file 1: ");
		String vectorFile1 = scanner.next();
		
		System.out.print("\nPath to vector file 2: ");
		String vectorFile2 = scanner.next();
				
		System.out.print("\nPath to where the alignment file will be stored (e.g. labelMatcher04.rdf):");
		String alignmentOutput = scanner.next();
...
//
		...
		File ontoFile1 = new File(ontoFile1Path);
		File ontoFile2 = new File(ontoFile2Path);
//		
//		/** SELECT VECTOR FILES **/		
...
//		final File dbFile = new File("/Users/audunvennesland/Documents/PhD/Development/Neo4J/biblio-bibo2");
		...
		case "WE-GLOBAL":
			...
			alignmentFileName = alignmentOutput;
